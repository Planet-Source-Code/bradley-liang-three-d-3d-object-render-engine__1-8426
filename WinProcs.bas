...
' here i output all shaded triangles with an user palette.
...
'Set the Color Palatte for shading within the canvas (pict)
'using Device Context memory blocks.
...
' Output triangles to canvas object (Pict)
  Dim Brush As Long
  Dim rc As Long
  Dim Region As Long
  Dim BaseCol As Long
